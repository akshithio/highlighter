(() => {
  ...
  var notesMainEl = document.querySelector("#notes-main");
  var notesFooterEl = document.querySelector("#notes-footer");
  var enableAccessButton = document.querySelector("#enable-access");
  var accessStatusEl = document.querySelector("#access-status");
  ...
  async function refresh() {
    ...
    try {
      ...
      render3(currentPage.highlights || []);
    } catch {
      try {
